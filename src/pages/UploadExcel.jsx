...
//     setAnswer("");
//     await askQuestion(question, currentFileId);
//   };
...
//   return (
//  <div className={`min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 p-4 md:p-8 ${isAIChatOpen ? 'mr-96' : ''}`}>      {/* Upload Modal */}
//       {showModal && (
...
//                     </div>
//                     <div>
//                       <span className="font-bold text-gray-800 text-sm block">Data Results</span>
